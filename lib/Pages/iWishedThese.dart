...
class iWished extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(title: 'Ma liste de souhaits', leadingIconPath: '', firstActionIconPath: 'assets/Icones/close.svg', secondActionIconPath: '', appBarId: 1, liked: false, whished: false, ),
      body: Stack(
          children: <Widget> [
